/**
 * =============================================================
 * start.js — Handler do comando /start
 * =============================================================
 * Responsabilidade: Dar boas-vindas ao usuário e apresentar
 * as funcionalidades do bot.
 */
...
/**
 * Registra o handler de /start no bot.
 *
...
export function registerStartCommand(bot) {
  bot.start(async (ctx) => {
    ...
    try {
      // Registra o usuário no banco se ainda não existir
...
_Boa sorte\\! 🚀_
  ...
  // Arquivo movido para src/commands/start.js

/**
 * Escapa caracteres especiais do MarkdownV2 do Telegram.
 * Necessário para evitar erros de parsing na API.
 *
 * @param {string} text
 * @returns {string}
 */
